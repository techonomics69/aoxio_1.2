            ...
            <div class="col-md-10 col-lg-6 mb-3 mb-lg-0">
                ...
                <ul class="list-unstyled social-icon3 mt-2">
                    <?php if (!empty($company->facebook)) : ?>
                        <li><a href="<?= $company->facebook; ?>"><i class="lni lni-facebook-original"></i></a></li>
                    <?php endif ?>

                    <?php if (!empty($company->twitter)) : ?>
                        <li><a href="<?= $company->twitter; ?>"><i class="lni lni-twitter"></i></a></li>
                    <?php endif ?>

                    <?php if (!empty($company->instagram)) : ?>
                        <li><a href="<?= $company->instagram; ?>"><i class="lni lni-instagram-original"></i></a></li>
                    <?php endif ?>
                    ...
                    <ul class="list-unstyled mb-5 pb-0">
                        ...
                        <li class="py-1">
                            <div class="d-flex">
                                ...
                                <?= '&nbsp; ('.$my_days[$i-1]['start'].'-'.$my_days[$i-1]['end'].')' ?>
                                <?php endif ?>
