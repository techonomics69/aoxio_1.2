                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-whites py-3">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                ...
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('users') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Companies"){echo "active";} ?>"><?php echo trans('companies') ?></a></li>
                                <?php endif ?>
