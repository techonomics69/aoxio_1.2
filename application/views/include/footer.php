            ...
            <div class="col-sm-5 col-lg-5 mb-5 mb-lg-0">
                ...
                <ul class="list-unstyled social-icon2 mb-0">
                    <?php if (!empty($settings->facebook)) : ?>
                        <li><a href="<?= $settings->facebook; ?>"><i class="lni lni-facebook-original"></i></a></li>
                    <?php endif ?>

                    <?php if (!empty($settings->twitter)) : ?>
                        <li><a href="<?= $settings->twitter; ?>"><i class="lni lni-twitter"></i></a></li>
                    <?php endif ?>
                    ...
                    <?php if (!empty($settings->instagram)) : ?>
                        <li><a href="<?= $settings->instagram; ?>"><i class="lni lni-instagram-original"></i></a></li>
                    <?php endif ?>
                </ul>
            </div>
