                ...
                <?php $i=1; foreach ($payments as $payment): ?>
                  ...
                  <?php if ($payment->amount != '0.00'): ?>
                    <tr id="row_<?php echo html_escape($payment->id); ?>">
                        ...
                        <td class="actions">
                          <a target="_blank" href="<?php echo base_url('admin/payment/receipt/'.$payment->puid) ?>" class="pull-right btn btn-secondary btn-xs"><i class="fa fa-eye"></i> <?php echo trans('view-invoice') ?></a>
                        </td>
                    </tr>
                  <?php endif ?>
