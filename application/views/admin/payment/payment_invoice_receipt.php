    ...
    <div class="invoice-box print_area <?php if(isset($page_title) && $page_title != 'Export'){echo "br1 shadow-lg";} ?>">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td class="text-right"><span><strong><?php if(settings()->curr_locate == 0){echo settings()->currency_symbol;} ?><?php echo get_tax_rate(number_format($price,settings()->num_format), $user->tax) ?> <?php if(settings()->curr_locate == 1){echo settings()->currency_symbol;} ?></strong></span></td>
            </tr>
            <?php endif ?>
