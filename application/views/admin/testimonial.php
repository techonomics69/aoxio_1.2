  ...
  <section class="content">
    ...
    <div class="box add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit"): ?>
            <a href="<?php echo base_url('admin/testimonial') ?>" class="pull-right btn btn-light-secondary btn-sm"><i class="fa fa-angle-left"></i> Back</a>
          <?php else: ?>
            <a href="#" class="text-right btn btn-light-secondary btn-sm cancel_btn"><i class="fa fa-list"></i> Testimonial</a>
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="box list_area">
      <div class="box-header with-border">
        ...
        <?php if (isset($page_title) && $page_title == "Edit"): ?>
          <h3 class="box-title">Edit testimonial <a href="<?php echo base_url('admin/testimonial') ?>" class="pull-right btn btn-light-secondary btn-sm"><i class="fa fa-angle-left"></i> Back</a></h3>
        <?php else: ?>
          <h3 class="box-title">All Testimonials </h3>
        <?php endif; ?>

        <div class="box-tools pull-right">
         <a href="#" class="pull-right btn btn-light-secondary btn-sm add_btn"><i class="fa fa-plus"></i> Add new testimonial</a>
        </div>
      </div>
