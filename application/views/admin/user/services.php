                    ...
                    <table class="table table-hover text-nowrap <?php if(count($services) > 10){echo "datatable";} ?>">
                      ...
                      <tbody>
                        ...
                        <tr id="row_<?php echo html_escape($service->id); ?>">
                          ...
                          <td>
                            <p class="p-0 m-0">
                              <span class="badge badge-light"><i class="far fa-user"></i> <?php if($service->capacity == -1){echo "Unlimited";}else{echo html_escape($service->capacity).' '.trans('person');} ?> </span>
                            </p>
                            <p class="p-0 m-0">
                              <span class="badge badge-light"><i class="far fa-clock"></i> <?php if($service->duration == -1){echo "Unlimited";}else{echo html_escape($service->duration).' '.trans($service->duration_type);} ?></span>
                            </p>
                          </td>
