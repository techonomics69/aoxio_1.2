              ...
              <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/customers/add')?>" role="form" novalidate>
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="emali" class="form-control" name="email" placeholder="<?php echo trans('enter-email-for-username') ?>" value="<?php if(isset($customer[0]['email'])){echo html_escape($customer[0]['email']);} ?>" required>
                    </div>
                        ...
                        <tbody>
                          <?php $i=1; foreach ($customers as $row): ?>
                            <tr id="row_<?php echo html_escape($row->id); ?>">
                                ...
                                <td>
                                  <a href="<?php echo base_url('admin/customers/details/'.html_escape($row->id));?>" class="badge badge-primary-soft"><i class="far fa-eye"></i> <?php echo trans('view-details') ?></a>
                                </td>
                                <td class="actions">
                                  <div class="btn-group">
